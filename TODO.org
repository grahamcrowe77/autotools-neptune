* TODO Rename neptune.erl neptune_io.erl
To avoid namespace collision with neptune escript to
allow for a generated man page for the command and
include it in the HTML and PDF documentation.
