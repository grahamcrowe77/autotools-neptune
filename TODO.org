* TODO MacOS Portability
On MacOS share libraries are named .dylib instead .so.
Add a make conditional to add a symbolic link from .so to .dylib
if the target system appears to be a MacOS
